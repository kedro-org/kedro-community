...
# kedro_example_pharma documentation build
...
from kedro_example_pharma import __version__ as release

# -- Project information -----------------------------------------------------

project = "kedro_example_pharma"
copyright = "2018-2019, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack / Digital McKinsey"
...
latex_documents = [
    (
        master_doc,
        "kedro_example_pharma.tex",
        "kedro_example_pharma Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "kedro_example_pharma",
        "Project kedro_example_pharma codebase.",
        "Data-Science",
    )
]
