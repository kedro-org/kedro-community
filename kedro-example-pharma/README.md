# Kedro Pharma Example

## Overview

This is an example project, which was generated using `Kedro 0.15.0`. It is based on the completed version of the [Space Flights tutorial](https://kedro.readthedocs.io/docs/build/html/03_tutorial/02_tutorial_template.html) described in the Kedro [documentation](https://kedro.readthedocs.io) and includes the data necessary to run the project.

This version has been tailored for an example Pharmaceutical project, for demonstration to clients in LOPs.
